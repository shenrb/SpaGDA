...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--name', type=str, default='Testis', help='name of the experiment. It decides where to store samples and models')
        ...
        parser.add_argument('--input_dim', type=int, default=477, help='Dim of input, using HVG') # 997 v1, 767 v2
        parser.add_argument('--feat_hidden1', type=int, default=200, help='Dim of G-encoder hidden layer 1.')
        parser.add_argument('--feat_hidden2', type=int, default=100, help='Dim of G-encoder hidden layer 2.')
        ...
        parser.add_argument('--gene_groups', type=str,default='data/imputed_gene_folds_v6.json', help='if specified, print more debugging information')
...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--sc_data', type=str, default='data/testes_benchmark.h5ad', help='source scRNA-seq dataset, h5ad format.')
        parser.add_argument('--st_data', type=str, default='data/slide_DM1_v6.h5ad', help='target spatial transcriptomic dataset, h5ad format.')
        ...
        parser.add_argument('--ndf_di', type=int, default=4, help='# of discriminator (D, netD) filters in the first conv layer.')
        ...
        parser.add_argument('--sc_neighbors', type=int, default=10, help='K nearest neighbors to create sc_graph.')
        parser.add_argument('--st_neighbors', type=int, default=15, help='K nearest neighbors to create st_graph.')
        parser.add_argument('--dis_sigma', type=int, default=18, help='dis sigma of nearest neighbors to weight st_graph.')
        ...
        parser.add_argument('--print_freq', type=int, default=50, help='batch frequency of printing the loss')
