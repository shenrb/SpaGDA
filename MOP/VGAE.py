...
class VGAEModel(nn.Module):
    def __init__(self, opt):
        ...
        #self.encoder.add_module('encoder_L3', full_block(opt.feat_hidden2, opt.feat_hidden2, opt.p_drop))

        self.decoder = nn.Sequential()
        #self.decoder.add_module('decoder_L0', full_block(self.latent_dim, self.latent_dim, opt.p_drop))
