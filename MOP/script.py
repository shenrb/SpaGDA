...
if __name__ == '__main__':
    ...
    Imputed_Genes.to_csv('Results/ori_%s_imputed_SpaGDA_%s.csv'%(opt.model, time.strftime("%Y-%m-%d-%H-%M-%S", time.localtime())))
    ...
    output_st_adata.write('Results/ori_output_merfish_m1s3.h5ad')
