...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--sc_neighbors', type=int, default=15, help='K nearest neighbors to create sc_graph.')
        parser.add_argument('--st_neighbors', type=int, default=15, help='K nearest neighbors to create st_graph.')
        parser.add_argument('--dis_sigma', type=int, default=30, help='dis sigma of nearest neighbors to weight st_graph.')
