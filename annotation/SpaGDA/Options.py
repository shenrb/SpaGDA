...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--feat_hidden1', type=int, default=100, help='Dim of G-encoder hidden layer 1.')
        parser.add_argument('--feat_hidden2', type=int, default=40, help='Dim of G-encoder hidden layer 2.')
...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--sc_data', type=str, default='data/Moffit_RNA.h5ad', help='source scRNA-seq dataset, h5ad format.')
        ...
        parser.add_argument('--lambda_G', type=float, default=0.1, help='Weight of VGAE loss.')
